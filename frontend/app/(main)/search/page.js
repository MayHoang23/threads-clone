            ...
            <section>
              ...
              <div className="divide-y divide-gray-50">
                {results.hashtags.map((tag) => (
                  <div key={tag.name} className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-sm text-gray-900">#{tag.name}</p>
                        <p className="text-xs text-gray-400">{tag.postCount} bài viết</p>
                      </div>
                    </div>
                  </div>
                ))}
