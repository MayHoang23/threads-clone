export default {
  ...
  post: {
    ...
    uploading: "Đang tải...",
    repost: "Repost",
    undoRepost: "Bỏ repost",
    reposted: "đã repost",
    quote: "Trích dẫn",
    quoteTitle: "Trích dẫn bài viết",
    quotePlaceholder: "Thêm nhận xét...",
  },
  profile: {
    posts: "Bài viết",
    replies: "Trả lời",
  ...
  messages: {
    ...
    mediaMessage: "[Hình ảnh]",
    deleteConfirm: "Xóa tin nhắn này chỉ với bạn?",
  },
  notifications: {
    title: "Thông báo",
    viewAll: "Xem tất cả",
